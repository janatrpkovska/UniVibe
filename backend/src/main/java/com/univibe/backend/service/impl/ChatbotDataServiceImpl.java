...
public class ChatbotDataServiceImpl implements ChatbotDataService {
    ...
    private String buildTroubleshootingContext() {
        return """
            ...
            • Ако нема резултати - пробај да пребаруваш со помалку филтри
            • Ако не ти прикажува настани во категорија - веројатно се уште нема додадени
            • Ако не можеш да се најавиш, провери да не внесуваш погрешни информации(празно место, специјални знаци и сл.)
            • Пред да се најавиш - потребно е прво да се регистрираш

            
            Сè уште имаш проблем? Контактирај го тимот на UniVibe на следниов маил - univibe2025@yahoo.com
            """;
    }
